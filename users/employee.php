  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        $result = mysqli_query($conn,"SELECT p.userid,p.user_name,p.user_dept,p.user_email,p.user_pos,p.user_joined FROM user_info p INNER JOIN user_login c ON p.userid = c.user_id") or die(mysqli_error($conn));
        ...
        while($res = mysqli_fetch_array($result)){
            ...
            echo "<td>".$res['user_joined']."</td>";
            echo "<td><a href='empdetails.php?empid=".$res['userid']."'>View</a> | <a href='removeEmployee.php?empid=".$res['userid']."'>Remove Employee</a> </td>";
